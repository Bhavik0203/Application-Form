...
//     Object.entries(formData).forEach(([field, values]) => {
//       values.forEach((value, index) => {
//         if (value.trim() === "") {
//           newEmptyFields.push({ field, index });
//         }
//       });
//     });
...
//             <button className="close-button" onClick={closeValidationPopup}>
//               OK
//             </button>
//           </div>
//         </div>
...
//                       <textarea
//                         className={emptyFields.some(
//                           (emptyField) =>
//                             emptyField.field === field && emptyField.index === index
//                         )
//                           ? "error"
//                           : ""}
//                         value={item}
...
//           {Object.keys(submittedData).map((field) => (
//             <div key={field} className="submitted-section">
//               <h3>{field.split(/(?=[A-Z])/).join(" ")}</h3>
//               <ul>
//                 {submittedData[field].map((item, index) => (
...
// import { addCallingData } from '';

// Ensure this line calls the function correctly
// Example: addCallingData();
